// src/context/utils/gameUtils.js
import { monsterTemplates } from '../../utils/game-data';
import { rollForSpecialEvent, EVENT_TYPES } from '../../utils/special-events';
import { saveGame as saveGameToStorage, loadGame as loadGameFromStorage, hasSavedGame as checkSavedGame, deleteSavedGame as deleteGameFromStorage } from '../../utils/SaveLoadSystem';
import { ACTION_TYPES } from '../actions';

// Create game utility functions
export const createGameUtils = (state, dispatch) => {
  const gameUtils = {
    // Add a log entry
